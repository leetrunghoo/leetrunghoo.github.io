...
$(function() {
    ...
    // $comProjects = $('#projects .grid-item.company-project');
    // $petProjects = $('#projects .grid-item.pet-project');
    // $otherProjects = $('#projects .grid-item.other-project');
    var mapProjects = {};
